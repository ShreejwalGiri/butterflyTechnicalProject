...
public class ApiServices {
    ...
    private func returnDictionary(jsonString: NSString) -> String {
        ...
        do {
            ...
            if let dataDictValue = finalDictionary[paramsConstants.data] as? [String: Any] {
                ...
                finalDictionary.merge(finalDataDictVal) { _, _ in }
                finalDictionary.removeValue(forKey: paramsConstants.data)
                finalDictionary["dataMessage"] = dataMessage
                finalDictionary["arrayList"] = purchaseModels
            }

            let jsonData = try JSONSerialization.data(withJSONObject: finalDictionary, options: [.prettyPrinted])
